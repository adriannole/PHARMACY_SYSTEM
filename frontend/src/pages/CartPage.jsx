...
const CartPage = () => {
  ...
  const handleSortCart = async () => {
    try {
      const response = await fetch(`http://18.212.74.173:4010/sort_cart/${username}`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const deleteProduct = async (productName) => {
    ...
    try {
      setIsLoading(true);
      const response = await fetch("http://44.203.190.91:4003/delete_product", {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const updateQuantity = async (productName, quantity) => {
    try {
      setIsLoading(true);
      const response = await fetch("http://18.234.185.119:4011/update_quantity", {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const resetCart = async () => {
    ...
    try {
      setIsLoading(true);
      const response = await fetch(`http://54.167.88.120:4008/reset_cart/${username}`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const proceedToPayment = async () => {
    try {
      const response = await fetch("http://34.201.37.55:4002/checkout", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
